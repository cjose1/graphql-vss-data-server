...
###############################################################
set -e
#cjose1 git_clone_and_cd https://github.com/microsoft/cppgraphqlgen.git "$CPPGRAPHQLGENTAG" &
#cjose1 git_clone_and_cd https://github.com/Thalhammer/jwt-cpp.git "$JWT_CPPTAG" "${CLONE_SHALLOW_SINGLE_BRANCH[@]}" &
#cjose1 git_clone_and_cd https://github.com/zaphoyd/websocketpp.git "$WEBSOCKETPPTAG" "${CLONE_SHALLOW_SINGLE_BRANCH[@]}" &
